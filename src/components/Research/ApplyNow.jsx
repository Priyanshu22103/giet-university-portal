...
const ApplyNow = () => {
  ...
  try {
    ...
    if (data.success) {
      navigate("/application-form"); // <-- redirect here
    }
  } catch (err) {
  ...
  return (
    <>
      ...
      <span id="logo">
        <img src={img} height="120px" width="820px" alt="image" style={{border:'2px solid darkblue'}} />
      </span>
  ...
  <div className="form-content">
    {signUpStatus === "signup" ? (
      <form id="signupform" onSubmit={handleSignup}>
        ...
        <span>
          First Name: <span style={{ marginLeft: "270px" }}>Last Name:</span>
          <br /><br />
          <input
            type="text"
            name="firstName"
        ...
        <br /><br /><br />
        <span>
          Email Address: <span style={{ marginLeft: "243px" }}>Phone Number:</span> <br /><br />
          <input
            type="email"
            name="email"
        ...
        <span>
          Password:
          <span style={{ marginLeft: "284px" }}>Re Enter Password:</span> <br /><br />
          <input
            type="password"
            name="password"
        ...
        <br /><br />
        <input type="checkbox" style={{marginLeft:'-2px',width:'auto',paddingLeft:'-200px'}}/> Subscribe to our newsletter
  ...
  <div className="side-image">
    <img src={side_image} alt="sideimg" />
  </div>
</div>
    </>
  );
