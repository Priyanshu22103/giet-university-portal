...
const ApplyNow = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const res = await fetch(
        "http://localhost:8082/CandidateAuth/SignUpServlet",
        {
          method: "POST",
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch(
        "http://localhost:8082/CandidateAuth/LoginServlet",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
    ...
    <>
      <span id="topnavbar">
        <span style={{ marginLeft: "50px", marginRight: "100px" }}>
          ...
          <b style={{ color: "black" }}>
            Call/ WhatsApp:{" "}
            <span style={{ color: "blue" }}>7735745535</span>
          </b>
        </span>
      ...
      <div style={{ backgroundColor: "grey", height: "1px", width: "860px" }} />
      ...
      <div className="form-container">
        ...
        <div className="side-image">
          {/* FIXED ALT */}
          <img src={side_image} alt="Apply page side visual" />
        </div>
      </div>
    </>
  );
