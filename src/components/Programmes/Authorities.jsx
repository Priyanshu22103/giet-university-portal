...
<SubCard title="Academic Council -11" link="https://www.giet.edu/wp-content/uploads/2024/09/AC-Minutes-11.pdf" />
        ...
        <AuthorityCard title="The Board of Studies" className="last-two">
        <p style={{color: 'black'}}><strong>A:</strong> There shall be a Board of Studies for each branch or discipline of study or branches of study as the Academic Council may decide.</p>
        <p style={{color: 'black'}}><strong>B:</strong> The constitution, powers and functions of the Board of Studies shall be such as may be prescribed in the Statutes.</p>
      </AuthorityCard>

     <AuthorityCard title="Finance Committee">
        <table style={{color: 'black'}} className="last-two">
          <tbody>
            <tr>
...
<h1 style={{ ...center, color: 'black' }}>Other Committees</h1>
